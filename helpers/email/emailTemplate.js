        ...
        <div style="text-align: center;">
            ...
            <tbody>
                ...
                <td style="width: 596px; vertical-align: top; padding-left: 0; padding-right: 0; padding-top: 15px; padding-bottom: 15px;" width="596">
                    ...
                    <!-- Your logo is here -->
                    <img style="max-width: 130px; text-align: center; color: #ffffff;" alt="Logo" src="https://invoice-platform-images-public.s3.amazonaws.com/651a426e2d7da94d05b00ced-image-profile" align="center">
            ...
            <table align="center" style="text-align: center; width: 600px; max-width: 600px; background-color: #F5F5F5;" width="600">
                <tbody>
                <tr>
                    <td style="width: 596px; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
                    ...
                    <p style="text-align:justify; margin-top: 30px; font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #000000;">Adjunto a este correo electrónico, encontrará el archivo PDF con los detalles completos de su cotización. Por favor, revise el documento y no dude en ponerse en contacto con nosotros si tiene alguna pregunta o si necesita información adicional.</p>
                                    ...
                                    <p style="text-align:justify; font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #000000;">¡ Agradecemos su interés y esperamos poder atenderlo pronto !</p>
                                                ...
                                                <h2 style="text-align:left;  font-size: 17px; margin-top: 50px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000;">LA CENTRAL DE OVEROLES SAS ZOMAC</h2>
            ...
            <table align="center" style="text-align: center; vertical-align: top; width: 600px; max-width: 600px; background-color: #000000;" width="600">
                ...
                <tr>
                    ...
                    <img style="max-width: 80px; text-align: center; color: #ffffff;" alt="Logo" src="https://invoice-platform-images-public.s3.amazonaws.com/651a426e2d7da94d05b00ced-image-profile" align="center">
